  ...
  renderSLI() {
    return (
      <SLI
        ...
        content3={`RECOMMENDATIONS: Rational management and maintenance, maintenance of precise and delicate equipment; quality design of products, interior design, management of small business.`}
  ...
  renderILE() {
    return (
      <ILE
        ...
        content1={`STRENGTHS: Well-developed learning-oriented thinking. Erudite, inquisitive, reads a lot and remembers it, Has developed intuition that helps him to make the right decisions. Structuralist and classifier.`}
