  ...
  renderSLI() {
    return (
      <SLI
        ...
        content1={`STRENGTHS: Resonable,aimed at some pragmatic purpose,knows how to adept to new ideas,Organises things for Leisure,diligence,perseverance..`}
        content2={`WEAKNESS: Skeptic,Likes to analyze and ridicule,Very dependent on internal moods and states,Reserverd and usually doesn't like excessive familiarity`}
        content3={`Recommended profession include Rational management and maintenance,maintenance of precise and delicate equipment; quality design of products, interior design, management of small business`}
  ...
  renderSEI() {
    return (
      <SEI
        ...
        content1={`STRENGTHS: Good taste and sense of measure and proportions,Caring and attentive to others,Diplomatic,Friendly,Attentive`}
        content2={`WEAKNESS: Vulnerable,Pretends that he can do much when it is not possible`}
        content3={`RECOMMENDATIONS: He is well capable of establishing and maintaining beneficial business contacts. Successful in spheres where he needs to look out for needs of a specific individual. SEI is a specialist in creating and maintaining the infrastructure of society. He is the best supplier, trader of small wholesale, director of a small company, the manager-diplomat. They make good quality evaluators, designers, and organizers.`}
  ...
  renderIEI() {
    return (
      <IEI
        ...
        content1={`STRENGTHS: Considerate, tactful, gentle person.`}
        content2={`WEAKNESSES: Intrinsically vulnerable, contradictory. Somewhat unsure of himself. Prone to experiencing doubts and fluctuations in arriving at a decision`}
        content3={`RECOMMENDATIONS: Best if occupation relates to humanities. Can work well anywhere where he is required to elegantly communicate with a small group of people. Recommended professions include translator, librarian, writer, journalist, editor, may realize themselves in the field of arts as critics, writers, and poets.`}
  ...
  renderILI() {
    return (
      <ILI
        ...
        content1={`STRENGTHS: Oriented at making rational, gainful actions,Economical, fastidious in work, conscientious and operative,Erudite,Remembers what he has read in great detail and vividly recounts it for others,strong intuition,Punctual.`}
        content2={`WEAKNESS: Poorly maintains internal balance,Cautious and hesitant in new endeavors`}
        content3={`RECOMMENDATIONS: Applied research in fields of physics, mathematics, macroeconomics; conceptual analysis of complex problems; assessments of levels of risk, counseling and prognosis; philosophy, history and archaeology; informatics, archives and library work.`}
  ...
  renderESI() {
    return (
      <ESI
        ...
        content1={`STRENGTHS: Well versed in relations between people. Conscientious, responsible, punctual,creates order,Stable in his habits and affections`}
        content2={`WEAKNESS : Painfully endures injustice and unethical behavior. Vulnerable and impressionable`}
        content3={`RECOMMENDED: The social sphere, areas that require interaction with people. Tedious work with physical component that requires focus and concentration, such as medicine and health (especially applied fields: dentistry, massage, working nurse, acupuncture, physical therapy, X-ray, biochemical diagnostics). Service and commodities sector: accounting, bookkeeping, seller and cashier.`}
  ...
  renderEII() {
    return (
      <EII
        ...
        content1={`STRENGTHS :Well versed in human relationships. Strives for self-improvement and erudition,understanding and tolerance`}
        content2={`WEAKNESS :Impressionable and vulnerable, Poorly tolerates loneliness,Very meticulous`}
        content3={`RECOMMENDED: Educational work with young people, psychotherapy, work in theoretical and humanitarian spheres, photography and digital arts.`}
  ...
  renderLII() {
    return (
      <LII
        ...
        content1={`STRENGTHS: Has highly developed logic and excels in analytical thinking, By nature he is kind, but puts objective factors above personal interests and relationships, good sense of time`}
        content2={`WEAKNESS: Insufficiently flexible in relation,Doesn't like doing many things at once,Doesn't like doing many things at once`}
        content3={`RECOMMENDED: Research and analytical work, analysis of complex phenomena and objects. Development of new ideas for practical application. "Analyst" work well everywhere where there is demand for system analysis, for creation and development of classification schemes and forwarding of alternative concepts. In the U.S. this type of work is called "business reorganizer".`}
  ...
  renderSEE() {
    return (
      <SEE
        ...
        content1={`STRENGTHS: Has good diplomatic and business capabilities. Quickly orients in extreme situations. Confident in him/herself. Bold and decisive, and kind at the same time,makes decisions independently`}
        content2={`WEAKNESS:Quite disorganized, inclined to get distracted at work by minor details. Finds it difficult to concentrate his attention on one thing for a long time. Prone to fluctuations when having to make a choice, which leads to inner reflections and doubts that he/she hides`}
        content3={`RECOMMENDED: Social sphere: trade (especially wholesale), supply of material resources; diplomatic representation, organization and leadership of cultural events; show business, the entertainment sphere, stage performance.`}
  ...
  renderIEE() {
    return (
      <IEE
        ...
        content2={`WEAKNESS: Due to his desire to maintain positive relations with many people, he can overload himself with useless contacts. Too trusting by nature and can say too much in conversation. Becomes quickly disappointed in his initial positive sympathies. May become too detached and exalted, too dependent on his moods`}
        content3={`RECOMMENDED: The humanitarian sphere. Teaching, art, journalism, psychology, career advising, marriage counseling, advertising.`}
  ...
  renderLSE() {
    return (
      <LSE
        ...
        content1={`STRENGTHS: Energetic and assertive person,A good administrator,pragmatic,Knows how to safely and efficiently handle money,punctual`}
        content2={`WEAKNESS:  Dislikes admitting to his mistakes,Poorly receives criticism,Sensitive to stress`}
        content3={`RECOMMENDED:  the management sphere, positions where there is a need to manage and direct people and coordinate their work and activities (under stable conditions and laws); economists, bank employees, loan officers, technical secretaries with managerial functions, support of the technical process (repair and maintenance of equipment); construction, farming and agriculture.`}
  ...
  renderESE() {
    return (
      <ESE
        ...
        content1={`STRENGTHS: Active, optimistic, and well-wishing person,pleasant and charming conversation partner`}
        content2={`WEAKNESS: Not very economical,has a tendency to overload himself with unnecessary tasks and activities, Overestimates his practical and business acumen`}
        content3={`RECOMMENDED:  improving the infrastructure of society; advertising, sociological work, medicine, healthcare, design and decoration, the service sector, trade, management and organization in social and scientific fields (organization of fairs, workshops, conferences, recreation, celebrations).`}
  ...
  renderEIE() {
    return (
      <EIE
        ...
        content1={`STRENGTHS: Emotional,Can inspire people with their emotions and make them follow him, Farsighted and shrewd,usually occupies positions of educator and mentor`}
        content2={`WEAKNESS: Has much difficulty achieving inner balance,Self-immolating, vulnerable,Does not like being interrupted and rushed,Very sensitive to failures and disappointments`}
        content3={`RECOMMENDED: Humanitarian sphere, where it is necessary to promote any idea, philosophy, or religion. Can be great in sales and insurance business, where it is necessary to emotionally engage the customer. Performs well in sphere of arts, where it is necessary to express emotions (theater, public speaking).`}
